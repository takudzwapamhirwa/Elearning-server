...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const html = await ejs_1.default.renderFile(path_1.default.join(__dirname, "../mails/ctivation-mail.ejs"), data);
        try {
...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.default("Please login for access to this resources", 400));
        }
